lazy_static::lazy_static! {
    pub static ref T: std::collections::HashMap<&'static str, &'static str> =
        [
            ...
            ("{} sessions", "{} 个会话"),
            ("scam_title", "谁让你安装这个软件的？？？"),
            ("scam_text1", "如果对方是公检法，要求你安装这个软件协助调查"),
            ("scam_text2", "他们铁定是骗子，请立即挂断电话，到附近的辖区派出所寻求帮助"),
            ("Don't show again", "公检法没有远程办案的，下次不再显示"),
            ("I Agree", ""),
            ("Decline", "拒绝"),
